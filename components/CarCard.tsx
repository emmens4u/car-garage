            ...
            <div className='relative w-full mt-2 flex'>
                <div className='flex group-hover:invisible w-full justify-between text-gray-500'>
                    <div className='flex flex-col justify-center items-center gap-2'>
                        <Image src="/gas.svg" width={20} height={20} alt="steering wheel" className='object-contain' />
                    ...
                    <div className='flex flex-col justify-center items-center gap-2'>
                        <Image src="/tire.svg" width={20} height={20} alt="steering wheel" className='object-contain' />
                        <p className='text-[14px] '>
                            {drive.toUpperCase()}
                        </p>
                    </div>
